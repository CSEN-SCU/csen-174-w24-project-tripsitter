        ...
        Expanded(
          ...
          child: Column(
              ...
              children: [
                ...
                Text(
                    "${car.selected!.sipp.fromSipp()} (${car.selected!.carName} or similar)"),
                Text(
                    "Pickup at ${car.selected!.provider.providerName} @ ${car.selected!.pu}, Dropoff at ${car.selected!.doo}"),
              ]),
        ),
        if (!split)
          Expanded(
            ...
            children: [
              ...
              if (showBooking)
                ElevatedButton(
                  ...
                  onPressed: () {
                    launchUrl(Uri.parse(
                        "https://skyscanner.com${car.selected!.dplnk}"));
                  },
