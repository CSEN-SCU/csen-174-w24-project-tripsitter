  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListTile(
          ...
          title: Text(trip.name, style: sectionHeaderStyle.copyWith(fontSize: isMobile ? 20: 25)),
          trailing: Text("\$$price", style: TextStyle(color: Colors.black, fontSize: 15)),
          subtitle: Column(
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget tripList = Column(
      ...
      children: [
        Text("My Trips", style: sectionHeaderStyle.copyWith(
        ...
        Builder(builder: (context) {
          ...
          if (upcoming) {
            ...
            trips = trips
                ...
                .sortedBy((element) => element.startDate).reversed
                .toList();
          }
          if(isMobile) {
            return Column(
              children: [
                for (var trip in trips) TripInfo(trip: trip, col: trips.indexOf(trip) % 2 == 0 ? const Color.fromARGB(255, 245, 245, 245) : const Color.fromARGB(255, 217, 217, 217))
              ],
            );
          }
          return Expanded(
                      ...
                      leading: CircleAvatar(
                        ...
                        child:
                            !(profile.hasPhoto && image != null)
                                ...
                                : null),
                      title: Text(profile.name, style: sectionHeaderStyle,),
                      subtitle: Text("Tripping since ${DateFormat.yMMM().format(profile.joinDate)}\nNumber of Trips: ${profile.numberTrips}"),
                      isThreeLine: true,
                    ),
                    Row(
